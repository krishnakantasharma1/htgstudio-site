...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  {/* ✅ Always visible, even on mobile */}
    <Link
        href="/courses"
            className="text-gray-700 hover:text-blue-600 transition text-sm sm:text-base font-medium"
              >
                  Courses
                    </Link>
                              ...
                              className="text-gray-700 hover:text-blue-600 transition text-sm sm:text-base font-medium"
                                >
                                    About
                                        ...
                                        {/* ✅ Conditional links when logged in */}
                                          {hasAccess && (
                                              <>
                                                    <Link
                                                            href="/contact"
                                                                    className="hidden sm:inline hover:text-blue-600 transition text-sm sm:text-base font-medium"
                                                                          >
                                                                                  Contact
                                                                                        </Link>
                                            ...
                                            {/* ✅ Account/Login Icon — now always visible and tappable */}
                                                                                    ...
                                                                                    className="flex items-center justify-center w-9 h-9 rounded-full bg-blue-100 hover:bg-blue-200 text-blue-700 font-bold text-lg transition"
                                                                                            >
                                                                                                      {user.email?.[0]?.toUpperCase()}
                                                                                                                      ...
                                                                                                                      {menuOpen && (
                                                                                                                                <div className="absolute right-0 mt-3 w-44 sm:w-48 bg-white rounded-xl shadow-lg border border-gray-100 text-sm py-2">
