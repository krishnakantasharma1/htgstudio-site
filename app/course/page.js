...
>
  Unlock Your Phone’s Hidden Power 
        ...
        {/* 🎥 Promo Video (YouTube Embed – Clean, No Frame) */}
...
<PromoVideo />
        ...
        >
          💥 Get Instant Access – <CurrencyPrice inr={175} usd={1.99} /> &nbsp; Lifetime
        </motion.button>
...
<section className="py-16 px-4 sm:px-6 max-w-4xl mx-auto text-center border-t border-gray-100 bg-gradient-to-b from-blue-50 to-white rounded-2xl shadow-sm mt-10">
  ...
  >
    ...
    <div className="text-4xl sm:text-5xl font-bold text-blue-600"><CurrencyPrice inr={175} usd={1.99} />
</div>
  ...
  >
    💥 Get the Course for Just <CurrencyPrice inr={175} usd={1.99} />
